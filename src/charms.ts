...
export const charm_synergies = {
  dashmaster_sprintmaster: {
    name: "Dashmaster + Sprintmaster",
    description:
      "Further increases the movement speed bonus to 39%",
    charms: ["dashmaster", "sprintmaster"],
  },
  dashmaster_sharp_shadow: {
    name: "Dashmaster + Sharp Shadow",
    description:
      "Increases the damage dealt by the shadow to 1.5 x Nail damage. Does not affect charge or cooldown time.",
    charms: ["dashmaster", "sharp_shadow"],
  },
  fury_of_the_fallen_grubberflys_elegy: {
    name: "Fury of the Fallen + Grubberfly's Elegy",
    description:
      "Fires red projectiles at one Mask, dealing ~67.5% Nail damage per projectile.",
    charms: ["fury_of_the_fallen", "grubberflys_elegy"],
  },
  fury_of_the_fallen_glowing_womb: {
    name: "Fury of the Fallen + Glowing Womb",
    description:
      "Increases any spawned hatchlings' contact damage by 5 when on 1 Mask.",
    charms: ["fury_of_the_fallen", "glowing_womb"],
  },
  grubberflys_elegy_mark_of_pride: {
    name: "Grubberfly's Elegy + Mark of Pride",
    description:
      "Increases the size of the projectiles from Grubberfly's Elegy by 35%.",
    charms: ["grubberflys_elegy", "mark_of_pride"],
  },
  defenders_crest_flukenest: {
    name: "Defender's Crest + Flukenest",
    description:
      "Replaces the horde of flukes with one massive, volatile fluke that does 3 impact damage and explodes into a dung cloud that does 1 damage per tick for 23 ticks.",
    charms: ["defenders_crest", "flukenest"],
  },
  defenders_crest_glowing_womb: {
    name: "Defender's Crest + Glowing Womb",
    description:
      "Lowers Hatchling contact damage by 5, adding it back in the form of a 1-second dung cloud that does on average 4-5 damage.",
    charms: ["defenders_crest", "glowing_womb"],
  },
  defenders_crest_spore_shroom: {
    name: "Defender's Crest + Spore Shroom",
    description:
      "Increases the damage of the spore cloud to 2 damage per tick and makes the cloud last 4.1 seconds. However, tick frequency is decreased, allowing for only 20 ticks (40 total damage). Changes the visuals of the cloud.",
    charms: ["defenders_crest", "spore_shroom"],
  },
  shape_of_unn_quick_focus: {
    name: "Shape of Unn + Quick Focus",
    description:
      "Doubles the movement speed of the Shape of Unn form (6.0 -> 12.0).",
    charms: ["shape_of_unn", "quick_focus"],
  },
  deep_focus_spore_shroom: {
    name: "Deep Focus + Spore Shroom",
  ...
  grubsong_grubberflys_elegy: {
    name: "Grubsong + Grubberfly's Elegy",
    description:
      "The amount of SOUL received from taking damage is increased by 10 (to 25).",
    charms: ["grubsong", "grubberflys_elegy"],
  },
  grubsong_weaversong: {
    name: "Grubsong + Weaversong",
    description:
      "The Weaverlings collect 3 SOUL upon striking an enemy.",
    charms: ["grubsong", "weaversong"],
  },
  dream_wielder_dreamshield: {
    name: "Dream Wielder + Dreamshield",
    description: "The shield is 15% larger.",
    charms: ["dream_wielder", "dreamshield"],
  },
  sprintmaster_weaversong: {
    name: "Sprintmaster + Weaversong",
    description: "Weaverlings move 50% faster.",
    charms: ["sprintmaster", "weaversong"],
  },
};
